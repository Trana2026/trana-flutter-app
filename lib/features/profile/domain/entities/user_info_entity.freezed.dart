...
@override
String toString() {
  return 'UserInfoEntity(publicCode: $publicCode, email: $email, status: $status, ageGroup: $ageGroup, guardianVerifiedAt: $guardianVerifiedAt, name: $name, birthDate: $birthDate, gender: $gender, phone: $phone, pushEnabled: $pushEnabled)';
}
...
as UserStatus,ageGroup: null == ageGroup ? _self.ageGroup : ageGroup // ignore: cast_nullable_to_non_nullable
