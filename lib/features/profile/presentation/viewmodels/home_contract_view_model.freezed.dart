...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeContractState&&const DeepCollectionEquality().equals(other.myContracts, myContracts)&&const DeepCollectionEquality().equals(other.requestedContracts, requestedContracts)&&(identical(other.selectedStatus, selectedStatus) || other.selectedStatus == selectedStatus)&&(identical(other.searchQuery, searchQuery) || other.searchQuery == searchQuery)&&(identical(other.isLoadingMyContracts, isLoadingMyContracts) || other.isLoadingMyContracts == isLoadingMyContracts)&&(identical(other.error, error) || other.error == error));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(myContracts),const DeepCollectionEquality().hash(requestedContracts),selectedStatus,searchQuery,isLoadingMyContracts,error);

@override
String toString() {
  return 'HomeContractState(myContracts: $myContracts, requestedContracts: $requestedContracts, selectedStatus: $selectedStatus, searchQuery: $searchQuery, isLoadingMyContracts: $isLoadingMyContracts, error: $error)';
}
...
@useResult
$Res call({
 List<ContractEntity> myContracts, List<ContractEntity> requestedContracts, ContractStatus? selectedStatus, String searchQuery, bool isLoadingMyContracts, String? error
});
...
/// Create a copy of HomeContractState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? myContracts = null,Object? requestedContracts = null,Object? selectedStatus = freezed,Object? searchQuery = null,Object? isLoadingMyContracts = null,Object? error = freezed,}) {
...
as ContractStatus?,searchQuery: null == searchQuery ? _self.searchQuery : searchQuery // ignore: cast_nullable_to_non_nullable
as String,isLoadingMyContracts: null == isLoadingMyContracts ? _self.isLoadingMyContracts : isLoadingMyContracts // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<ContractEntity> myContracts,  List<ContractEntity> requestedContracts,  ContractStatus? selectedStatus,  String searchQuery,  bool isLoadingMyContracts,  String? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HomeContractState() when $default != null:
return $default(_that.myContracts,_that.requestedContracts,_that.selectedStatus,_that.searchQuery,_that.isLoadingMyContracts,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<ContractEntity> myContracts,  List<ContractEntity> requestedContracts,  ContractStatus? selectedStatus,  String searchQuery,  bool isLoadingMyContracts,  String? error)  $default,) {final _that = this;
switch (_that) {
case _HomeContractState():
return $default(_that.myContracts,_that.requestedContracts,_that.selectedStatus,_that.searchQuery,_that.isLoadingMyContracts,_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<ContractEntity> myContracts,  List<ContractEntity> requestedContracts,  ContractStatus? selectedStatus,  String searchQuery,  bool isLoadingMyContracts,  String? error)?  $default,) {final _that = this;
switch (_that) {
case _HomeContractState() when $default != null:
return $default(_that.myContracts,_that.requestedContracts,_that.selectedStatus,_that.searchQuery,_that.isLoadingMyContracts,_that.error);case _:
  return null;
...
class _HomeContractState extends HomeContractState {
  const _HomeContractState({final  List<ContractEntity> myContracts = const [], final  List<ContractEntity> requestedContracts = const [], this.selectedStatus, this.searchQuery = '', this.isLoadingMyContracts = false, this.error}): _myContracts = myContracts,_requestedContracts = requestedContracts,super._();
...
// 물품명 검색어
@override@JsonKey() final  bool isLoadingMyContracts;
// 사용자의 계약 전체 목록 로딩중 여부
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_myContracts),const DeepCollectionEquality().hash(_requestedContracts),selectedStatus,searchQuery,isLoadingMyContracts,error);
...
/// Create a copy of HomeContractState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? myContracts = null,Object? requestedContracts = null,Object? selectedStatus = freezed,Object? searchQuery = null,Object? isLoadingMyContracts = null,Object? error = freezed,}) {
