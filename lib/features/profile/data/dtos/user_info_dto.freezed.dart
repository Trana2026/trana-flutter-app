...
class _UserInfoDto implements UserInfoDto {
  const _UserInfoDto({required this.publicCode, this.email, required this.status, required this.ageGroup, this.guardianVerifiedAt, this.name, this.birthDate, this.gender, this.phone, required this.pushEnabled});
