...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BlockedUserDto&&(identical(other.shareCode, shareCode) || other.shareCode == shareCode)&&(identical(other.blockedAt, blockedAt) || other.blockedAt == blockedAt));
}
...
@override
String toString() {
  return 'BlockedUserDto(shareCode: $shareCode, blockedAt: $blockedAt)';
}
...
class _BlockedUserDto implements BlockedUserDto {
  const _BlockedUserDto({required this.shareCode, required this.blockedAt});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BlockedUserDto&&(identical(other.shareCode, shareCode) || other.shareCode == shareCode)&&(identical(other.blockedAt, blockedAt) || other.blockedAt == blockedAt));
}
