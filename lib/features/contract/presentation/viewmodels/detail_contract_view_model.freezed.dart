...
// ContractEntity 필드
 ...
 Uint8List? get pdfBytes; String? get pdfUrl;// riskSignals
 bool get guardianNotConsented; bool get hasReportHistory; bool get isLoading; String? get error;
...
@override
int get hashCode => Object.hashAll([runtimeType,myRole,isCreator,attachmentCount,firstAttachmentUrl,publicCode,status,deliveryType,consentType,tradingPlatform,title,price,conditionSummary,conditionDetails,warrantyPeriodDays,createdAt,updatedAt,const DeepCollectionEquality().hash(attachmentIds),const DeepCollectionEquality().hash(attachmentImageUrls),const DeepCollectionEquality().hash(pdfBytes),pdfUrl,guardianNotConsented,hasReportHistory,isLoading,error]);

@override
String toString() {
  return 'DetailContractState(myRole: $myRole, isCreator: $isCreator, attachmentCount: $attachmentCount, firstAttachmentUrl: $firstAttachmentUrl, publicCode: $publicCode, status: $status, deliveryType: $deliveryType, consentType: $consentType, tradingPlatform: $tradingPlatform, title: $title, price: $price, conditionSummary: $conditionSummary, conditionDetails: $conditionDetails, warrantyPeriodDays: $warrantyPeriodDays, createdAt: $createdAt, updatedAt: $updatedAt, attachmentIds: $attachmentIds, attachmentImageUrls: $attachmentImageUrls, pdfBytes: $pdfBytes, pdfUrl: $pdfUrl, guardianNotConsented: $guardianNotConsented, hasReportHistory: $hasReportHistory, isLoading: $isLoading, error: $error)';
}
...
as String?,guardianNotConsented: null == guardianNotConsented ? _self.guardianNotConsented : guardianNotConsented // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Role? myRole,  bool isCreator,  int attachmentCount,  String? firstAttachmentUrl,  String publicCode,  ContractStatus status,  DeliveryType? deliveryType,  ConsentType? consentType,  String? tradingPlatform,  String? title,  int? price,  String? conditionSummary,  String? conditionDetails,  int warrantyPeriodDays,  DateTime? createdAt,  DateTime? updatedAt,  List<int> attachmentIds,  List<String> attachmentImageUrls,  Uint8List? pdfBytes,  String? pdfUrl,  bool guardianNotConsented,  bool hasReportHistory,  bool isLoading,  String? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DetailContractState() when $default != null:
return $default(_that.myRole,_that.isCreator,_that.attachmentCount,_that.firstAttachmentUrl,_that.publicCode,_that.status,_that.deliveryType,_that.consentType,_that.tradingPlatform,_that.title,_that.price,_that.conditionSummary,_that.conditionDetails,_that.warrantyPeriodDays,_that.createdAt,_that.updatedAt,_that.attachmentIds,_that.attachmentImageUrls,_that.pdfBytes,_that.pdfUrl,_that.guardianNotConsented,_that.hasReportHistory,_that.isLoading,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Role? myRole,  bool isCreator,  int attachmentCount,  String? firstAttachmentUrl,  String publicCode,  ContractStatus status,  DeliveryType? deliveryType,  ConsentType? consentType,  String? tradingPlatform,  String? title,  int? price,  String? conditionSummary,  String? conditionDetails,  int warrantyPeriodDays,  DateTime? createdAt,  DateTime? updatedAt,  List<int> attachmentIds,  List<String> attachmentImageUrls,  Uint8List? pdfBytes,  String? pdfUrl,  bool guardianNotConsented,  bool hasReportHistory,  bool isLoading,  String? error)  $default,) {final _that = this;
switch (_that) {
case _DetailContractState():
return $default(_that.myRole,_that.isCreator,_that.attachmentCount,_that.firstAttachmentUrl,_that.publicCode,_that.status,_that.deliveryType,_that.consentType,_that.tradingPlatform,_that.title,_that.price,_that.conditionSummary,_that.conditionDetails,_that.warrantyPeriodDays,_that.createdAt,_that.updatedAt,_that.attachmentIds,_that.attachmentImageUrls,_that.pdfBytes,_that.pdfUrl,_that.guardianNotConsented,_that.hasReportHistory,_that.isLoading,_that.error);case _:
  throw StateError('Unexpected subclass');
...
@override
int get hashCode => Object.hashAll([runtimeType,myRole,isCreator,attachmentCount,firstAttachmentUrl,publicCode,status,deliveryType,consentType,tradingPlatform,title,price,conditionSummary,conditionDetails,warrantyPeriodDays,createdAt,updatedAt,const DeepCollectionEquality().hash(_attachmentIds),const DeepCollectionEquality().hash(_attachmentImageUrls),const DeepCollectionEquality().hash(pdfBytes),pdfUrl,guardianNotConsented,hasReportHistory,isLoading,error]);
