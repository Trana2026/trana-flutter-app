...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AiAutoFillState&&(identical(other.autoFillConsentedAt, autoFillConsentedAt) || other.autoFillConsentedAt == autoFillConsentedAt)&&(identical(other.extractionId, extractionId) || other.extractionId == extractionId)&&(identical(other.platform, platform) || other.platform == platform)&&(identical(other.name, name) || other.name == name)&&(identical(other.amount, amount) || other.amount == amount)&&(identical(other.condition, condition) || other.condition == condition)&&(identical(other.details, details) || other.details == details)&&(identical(other.isLoadingAnalysis, isLoadingAnalysis) || other.isLoadingAnalysis == isLoadingAnalysis)&&(identical(other.isCompleted, isCompleted) || other.isCompleted == isCompleted)&&(identical(other.error, error) || other.error == error));
}


@override
int get hashCode => Object.hash(runtimeType,autoFillConsentedAt,extractionId,platform,name,amount,condition,details,isLoadingAnalysis,isCompleted,error);

@override
String toString() {
  return 'AiAutoFillState(autoFillConsentedAt: $autoFillConsentedAt, extractionId: $extractionId, platform: $platform, name: $name, amount: $amount, condition: $condition, details: $details, isLoadingAnalysis: $isLoadingAnalysis, isCompleted: $isCompleted, error: $error)';
}
...
@useResult
$Res call({
 DateTime? autoFillConsentedAt, int? extractionId, String platform, String name, int amount, String condition, String details, bool isLoadingAnalysis, bool isCompleted, String? error
});
...
/// Create a copy of AiAutoFillState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? autoFillConsentedAt = freezed,Object? extractionId = freezed,Object? platform = null,Object? name = null,Object? amount = null,Object? condition = null,Object? details = null,Object? isLoadingAnalysis = null,Object? isCompleted = null,Object? error = freezed,}) {
...
as String,isLoadingAnalysis: null == isLoadingAnalysis ? _self.isLoadingAnalysis : isLoadingAnalysis // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( DateTime? autoFillConsentedAt,  int? extractionId,  String platform,  String name,  int amount,  String condition,  String details,  bool isLoadingAnalysis,  bool isCompleted,  String? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AiAutoFillState() when $default != null:
return $default(_that.autoFillConsentedAt,_that.extractionId,_that.platform,_that.name,_that.amount,_that.condition,_that.details,_that.isLoadingAnalysis,_that.isCompleted,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( DateTime? autoFillConsentedAt,  int? extractionId,  String platform,  String name,  int amount,  String condition,  String details,  bool isLoadingAnalysis,  bool isCompleted,  String? error)  $default,) {final _that = this;
switch (_that) {
case _AiAutoFillState():
return $default(_that.autoFillConsentedAt,_that.extractionId,_that.platform,_that.name,_that.amount,_that.condition,_that.details,_that.isLoadingAnalysis,_that.isCompleted,_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( DateTime? autoFillConsentedAt,  int? extractionId,  String platform,  String name,  int amount,  String condition,  String details,  bool isLoadingAnalysis,  bool isCompleted,  String? error)?  $default,) {final _that = this;
switch (_that) {
case _AiAutoFillState() when $default != null:
return $default(_that.autoFillConsentedAt,_that.extractionId,_that.platform,_that.name,_that.amount,_that.condition,_that.details,_that.isLoadingAnalysis,_that.isCompleted,_that.error);case _:
  return null;
...
class _AiAutoFillState implements AiAutoFillState {
  const _AiAutoFillState({this.autoFillConsentedAt, this.extractionId, this.platform = '', this.name = '', this.amount = 0, this.condition = '', this.details = '', this.isLoadingAnalysis = false, this.isCompleted = false, this.error});
...
/// Create a copy of AiAutoFillState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? autoFillConsentedAt = freezed,Object? extractionId = freezed,Object? platform = null,Object? name = null,Object? amount = null,Object? condition = null,Object? details = null,Object? isLoadingAnalysis = null,Object? isCompleted = null,Object? error = freezed,}) {
