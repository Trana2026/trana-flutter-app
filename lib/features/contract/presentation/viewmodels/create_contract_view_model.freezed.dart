...
mixin _$CreateContractState {
 ...
 dynamic get mode;// 계약 작성 페이지 구분
 bool get isLoadingUpload;// 사진 업로드 로딩중 여부
 bool get isLoadingPdf;// PDF 생성 로딩중 여부
 String? get error;
...
/// Create a copy of CreateContractState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? role = freezed,Object? deliveryType = null,Object? publicCode = freezed,Object? selectedImages = null,Object? existingAttachmentUrls = null,Object? attachmentIds = null,Object? tradingPlatform = null,Object? title = null,Object? price = null,Object? conditionSummary = null,Object? conditionDetails = null,Object? warrantyPeriodDays = null,Object? pdfBytes = freezed,Object? mode = freezed,Object? isLoadingUpload = null,Object? isLoadingPdf = null,Object? error = freezed,}) {
...
as Uint8List?,mode: freezed == mode ? _self.mode : mode // ignore: cast_nullable_to_non_nullable
as dynamic,isLoadingUpload: null == isLoadingUpload ? _self.isLoadingUpload : isLoadingUpload // ignore: cast_nullable_to_non_nullable
as bool,isLoadingPdf: null == isLoadingPdf ? _self.isLoadingPdf : isLoadingPdf // ignore: cast_nullable_to_non_nullable
...
// 생성된 Pdf 바이트
@override@JsonKey() final  dynamic mode;
// 계약 작성 페이지 구분
@override@JsonKey() final  bool isLoadingUpload;
// 사진 업로드 로딩중 여부
@override@JsonKey() final  bool isLoadingPdf;
// PDF 생성 로딩중 여부
...
@override
int get hashCode => Object.hash(runtimeType,role,deliveryType,publicCode,const DeepCollectionEquality().hash(_selectedImages),const DeepCollectionEquality().hash(_existingAttachmentUrls),const DeepCollectionEquality().hash(_attachmentIds),tradingPlatform,title,price,conditionSummary,conditionDetails,warrantyPeriodDays,const DeepCollectionEquality().hash(pdfBytes),const DeepCollectionEquality().hash(mode),isLoadingUpload,isLoadingPdf,error);
