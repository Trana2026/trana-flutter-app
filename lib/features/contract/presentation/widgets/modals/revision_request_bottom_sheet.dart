...
class RevisionRequestBottomSheet extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // 전체 필드 기준으로 미리 생성 — visibleFields가 동적으로 늘어나도 재생성 불필요
    ...
    // Safe area bottom is 0 when keyboard is visible (home indicator hides)
    final safeAreaBottom = keyboardHeight > 0 ? 0.0 : mediaQuery.padding.bottom;
    // Fixed overhead: container padding(30) + handle(4) + spacing(20) + bottom padding(10)
                        ...
                        onTap: () async {
                          ...
                          try {
                            if (detailState.isCreator) {
                              ...
                              final success = await revisionVM.requestRevision(
