...
import 'package:trana/view/modal/contract_sign_dialog/contract_sign_dialog.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ConsentCheckbox(
            requiredText: "판매자의 설명을 충분히 확인했으며,\n",
            requiredColor: vrc(context).textPrimary,
            descriptionText: "해당 조건으로 거래를 진행함에 동의합니다.",
            onChanged: (value) {
          ...
          ConsentCheckbox(
            requiredText: "계약 확정 이후에는 서로의 합의없이 내용을 변경하거나,\n",
            requiredColor: vrc(context).textPrimary,
            descriptionText: "일방적으로 취소하기 어렵다는 점을 인지합니다.",
            onChanged: (value) {
              final newList = [...checkedStates.value];
              newList[1] = value;
              checkedStates.value = newList;
          ...
          ConsentCheckbox(
            requiredText: "보증 및 환불 조건은 계약서에 기재된 내용에 따르며,\n",
            requiredColor: vrc(context).textPrimary,
            descriptionText: "그 이행은 거래 당사자 간의 책임임을 확인합니다.",
            onChanged: (value) {
              final newList = [...checkedStates.value];
              newList[2] = value;
              checkedStates.value = newList;
          ...
          ConsentCheckbox(
            requiredText: "본 문서는 당사자 간 합의 내용을 기록한 문서이며,\n",
            requiredColor: vrc(context).textPrimary,
            descriptionText: "거래는 서로의 신뢰를 바탕으로 진행됨에 동의합니다.",
            onChanged: (value) {
              final newList = [...checkedStates.value];
              newList[3] = value;
              checkedStates.value = newList;
