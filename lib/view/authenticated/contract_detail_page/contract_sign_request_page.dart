...
class ContractSignRequestPage extends HookConsumerWidget {
  const ContractSignRequestPage({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          backgroundColor: fxc(context).statusSignRequest!,
          leading: InkWell(
